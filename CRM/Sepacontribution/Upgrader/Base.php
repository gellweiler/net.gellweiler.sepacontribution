 ...
 */
class CRM_Sepacontribution_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Sepacontribution_Upgrader(
        'net.gellweiler.sepacontribution',
        realpath(__DIR__ .'/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_Sepacontribution_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
